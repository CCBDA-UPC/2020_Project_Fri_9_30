...
<p align="center"><img src="./response1/Images/Q1.png" width="70%" height="70%" alt="command"/></p>

## Q2. Try the three methods for uploading data to Colab. Add screenshots to the response file.
##### From Local machine:
<p align="center"><img src="./response1/Images/Q2-1.png" width="70%" height="70%" alt="local machine"/></p>
##### From Google drive:
I encountered some errors as follows by following the tutorial.
<p align="center"><img src="./response1/Images/Q2-2(Problem).png" width="70%" height="70%" alt="google drive"/></p>
...
<p align="center"><img src="./response1/Images/Q2-2.png" width="70%" height="70%" alt="google drive"/></p>
...
<p align="center"><img src="./response1/Images/Q2-3.png" width="70%" height="70%" alt="S3"/></p>
...
<p align="center"><img src="./response1/Images/Q3.png" width="70%" height="70%" alt="dimensions"/></p>

## Q4: How much accuracy have you got? Is it satisfactory to you? If not, what could be done as a step to improve the accuracy?

<p align="center"><img src="./response1/Images/Q4.png" width="70%" height="70%" alt="accuracy"/></p>

I think the accuracy is pretty high. 

## Q5: Add a screenshot of the TensorBoard dashboard showing your training profiles.

<p align="center"><img src="./response1/Images/Q5.png" width="70%" height="70%" alt="dashboard"/></p>
