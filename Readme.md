...
- ID: Spanish phone number (Unique)
- Name: Last name
- Gender: 1 Male, 0 Female
- Occupation: 1-50 tags of occupation. For example, 23 = Software Engineer
- Income: Based on the Spain average salary by standard normal distribution and actual meaning adjustment
